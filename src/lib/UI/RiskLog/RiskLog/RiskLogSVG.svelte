...
<svg
  ...
  viewBox="0 0 262.32 55.61"
>
  <defs>
    <filter
      id="RiskLog_luminosity-invert"
      x="-2.02"
      y="-2.16"
      width="266.4"
      height="60"
      ...
      <g>
        <g opacity=".8">
          <rect
            ...
            stroke-width="0"
          />
          <g mask="url(#RiskLog_mask)">
            <g mix-blend-mode="screen" opacity=".8">
              <rect
                id="RiskLog_outer-color"
                width="262.32"
                height="55.61"
                rx="10.78"
                ry="10.78"
        ...
        <path
          d="M17.3,41.71c1.54,0,2.91-.42,4.12-1.25.24-.16.26-.34.04-.53-.7-.64-1.41-1.28-2.11-1.92-.16-.15-.3-.16-.51-.07-1.01.49-2.02.48-3.02,0-.21-.1-.35-.08-.52.07-.71.64-1.42,1.29-2.13,1.93-.21.19-.2.37.04.53,1.21.82,2.58,1.23,4.08,1.24ZM24.14,35.53c-.01-1.37-.46-2.61-1.36-3.72-.19-.24-.38-.25-.61-.04-.69.63-1.39,1.26-2.08,1.88-.19.17-.2.28-.08.49.54.91.54,1.82,0,2.73-.12.21-.11.33.08.49.7.63,1.39,1.27,2.09,1.9.22.2.41.19.6-.04.9-1.1,1.35-2.33,1.37-3.7ZM17.27,29.33c-1.33,0-2.6.35-3.75,1.05-.39.23-.44.63-.11.93.57.52,1.14,1.04,1.71,1.56.14.13.32.21.51.2.16,0,.32-.04.46-.1.4-.15.81-.24,1.24-.24.44,0,.85.09,1.25.25.41.16.69.1,1-.18.54-.49,1.07-.97,1.61-1.46.37-.34.33-.72-.11-.98-1.14-.69-2.4-1.03-3.83-1.03Z"
          fill="#f3edf7"
          stroke-width="0"
        />
        <path
          d="M10.49,35.11c.05-.3.09-.6.16-.9.17-.78.52-1.49,1.01-2.14.27-.36.69-.4,1.03-.1.46.41.92.83,1.38,1.25.09.08.18.16.27.25.32.29.38.54.2.92-.17.36-.26.72-.27,1.11,0,.38.08.75.24,1.1.21.45.16.67-.22,1.02-.53.48-1.07.96-1.6,1.44-.16.15-.36.23-.59.2-.19-.02-.33-.12-.44-.26-.66-.89-1.05-1.87-1.15-2.94,0-.04-.02-.08-.03-.13,0-.27,0-.54,0-.81Z"
          fill="#f3edf7"
          stroke-width="0"
        />
        <path
          d="M17.3,41.71c-1.5-.01-2.86-.42-4.08-1.24-.24-.16-.26-.34-.04-.53.71-.64,1.42-1.29,2.13-1.93.17-.15.31-.17.52-.07,1.01.49,2.01.5,3.02,0,.2-.1.35-.08.51.07.71.64,1.41,1.28,2.11,1.92.21.19.2.37-.04.53-1.22.83-2.59,1.24-4.12,1.25Z"
          fill="#f3edf7"
          stroke-width="0"
        />
        <path
          d="M24.14,35.53c-.02,1.37-.47,2.6-1.37,3.7-.19.23-.38.24-.6.04-.7-.63-1.39-1.26-2.09-1.9-.18-.17-.2-.28-.08-.49.53-.91.53-1.82,0-2.73-.12-.21-.1-.32.08-.49.69-.63,1.39-1.26,2.08-1.88.23-.21.41-.19.61.04.91,1.1,1.35,2.34,1.36,3.72Z"
          fill="#f3edf7"
          stroke-width="0"
        />
        <path
          d="M17.27,29.33c1.43,0,2.68.35,3.83,1.03.44.26.48.64.11.98-.53.49-1.07.97-1.61,1.46-.31.28-.6.34-1,.18-.4-.16-.82-.25-1.25-.25-.43,0-.84.09-1.24.24-.14.05-.31.09-.46.1-.2.01-.37-.07-.51-.2-.57-.52-1.15-1.04-1.71-1.56-.33-.3-.28-.69.11-.93,1.15-.7,2.42-1.05,3.75-1.05Z"
          fill="#f3edf7"
          stroke-width="0"
        />
        <path
          d="M17.32,10.35c-3.77,0-6.82,2.77-6.82,6.19s3.05,6.19,6.82,6.19,6.82-2.77,6.82-6.19-3.05-6.19-6.82-6.19ZM17.3,19.97c-.46,0-.83-.35-.83-.77,0-.42.39-.76.86-.76.46,0,.83.35.83.77,0,.42-.39.76-.86.76ZM18.28,14.08c-.07.72-.13,1.43-.2,2.15-.03.3-.05.59-.08.89-.04.33-.34.57-.7.56-.35,0-.64-.26-.67-.58-.09-1.02-.19-2.04-.28-3.05-.05-.51.4-.95.97-.95.58,0,1.02.46.96.98Z"
          fill="#f3edf7"
          stroke-width="0"
        />
      </g>
